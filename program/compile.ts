...
function compile(parsed: any[], iter: number): any[] {
  var output: (any | method)[] = [];
...
function parse(string: string, iter: number): parsed {
  var output: any[] = [];
  var current = "";
